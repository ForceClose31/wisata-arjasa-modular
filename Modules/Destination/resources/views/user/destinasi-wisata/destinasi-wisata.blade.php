    ...
    <section class="py-10 bg-gray-50">
        <div class="container mx-auto px-4 max-w-screen-xl">
            ...
            @if(isset($featuredPackages) && $featuredPackages->count() > 0)
                <div class="mt-20 bg-white rounded-2xl shadow-xl p-8" data-aos="fade-up" data-aos-delay="200">
                    <div class="text-center mb-10">
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2 font-montserrat">
                            {{ __('user.Paket Wisata Unggulan') }}
                        </h2>
                        <p class="text-gray-600">
                            {{ __('user.Jelajahi paket wisata lengkap untuk pengalaman tak terlupakan') }}
                        </p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        @foreach($featuredPackages as $package)
                            <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs text-gray-500">{{ __('user.Mulai dari') }}</p>
